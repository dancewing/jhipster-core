...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c184 = function(decl, ex) {
          parsed.tablePrefix[decl[decl.length - 1]] =
            parsed.tablePrefix[decl[decl.length - 1]] || { list: [], excluded: [] };
          addUniqueElements(parsed.tablePrefix[decl[decl.length - 1]].list, decl.slice(0, decl.length - 1));
          if (ex) {
            addUniqueElements(parsed.tablePrefix[decl[decl.length - 1]].excluded, ex);
          }
          return parsed.tablePrefix;
        },
      peg$c185 = "tablePrefix",
      peg$c186 = peg$literalExpectation("tablePrefix", false),
      peg$c187 = function(tablePrefix, p) {
          parsed.tablePrefix = tablePrefix;
          return parsed;
        },

      peg$c188 = "audit",
      peg$c189 = peg$literalExpectation("audit", false),
      peg$c190 = function(decl, ex) {
        	parsed.audit[decl[decl.length - 1]] =
            parsed.audit[decl[decl.length - 1]] || { list: [], excluded: [] };
          addUniqueElements(parsed.audit[decl[decl.length - 1]].list, decl.slice(0, decl.length - 1));
          if (ex) {
          	addUniqueElements(parsed.audit[decl[decl.length - 1]].excluded, ex);
          }
          return parsed.audit;
        },
      peg$c191 = function(audit, p) {
          parsed.audit = audit;
          return parsed;
      },
  ...
  function peg$parsetablePrefixDecl() {
    var s0, s1, s2, s3, s4, s5, s6, s7;

    s0 = peg$currPos;
    s1 = peg$parseTABLE_PREFIX();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$parseSPACE();
      while (s3 !== peg$FAILED) {
  ...
  function peg$parseTABLE_PREFIX() {
    var s0;
